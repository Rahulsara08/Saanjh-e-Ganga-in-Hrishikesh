        ...
        <RevealOnScroll delay={100}>
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-10 border-b border-[#DFC48F]/40">
            <div className="flex items-center space-x-4">
              <div className="w-14 h-14 rounded-2xl bg-[#FAF6F0] border border-[#DFC48F] flex items-center justify-center shrink-0 shadow-2xs text-[#C6A15B]">
                {/* Clean Plane Icon */}
            ...
            <div className="max-w-md md:text-right space-y-2">
              ...
              <div className="flex items-center justify-start md:justify-end space-x-2 pt-1">
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-full bg-[#FAF6F0] hover:bg-[#F3EDE3] text-[#4A4038] text-[10px] font-sans tracking-wide transition-colors border border-[#DFC48F] flex items-center space-x-1.5"
                >
